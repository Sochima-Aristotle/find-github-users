...
function UserSearch() {
    ...
    const handleSubmit = async e =>{
        ...
        if(text===''){
            setAlert('Please search user.', 'error')
        }else{
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-control">
                    <div className="relative">
                        <input type="text" className='w-full pr-40 bg-grey-200 input-lg text-black' placeholder='Search users' style={{borderRadius: '10px'}}value={text} onChange={handleChange}/>
